...
public class MNumberFormat
{
  ...
  public static String getRoundedRateCB(String paramString1, String paramString2, String paramString3)
  {
    ...
    double d4 = 0.0D;
    double d5 = d1 + 0.00015D / d1;
    if (d1 > 0.5D)
      d5 = Math.ceil(d1 * 10000.0D) / 10000.0D;
    d4 = d2 / d5 - d3;
    String str = "";
    NumberFormat localNumberFormat = NumberFormat.getInstance();
    localNumberFormat.setGroupingUsed(false);
    localNumberFormat.setMaximumFractionDigits(8);
    localNumberFormat.setMinimumFractionDigits(8);
 ...
 * Qualified Name:     com.maestro.crb.util.MNumberFormat
