package com.maestro.rateserver.maxim;
...
public class UserInfoDAO
{
    ...
    throws Exception
  {
    ...
    {
      String str = "INSERT INTO USER_INFO@" + this.dblink + " (SB_ID,FIRST_NAME,LAST_NAME,STREET,APT,CITY,ZIP_CODE,COUNTRY_ID,STATE,TIMEZONE_ID,EMAIL,PASSWORD,REGISTRATION_TIME, SB_STATUS,ACTOR,ME_ID) VALUES(" + paramUserInfoModel.getSbId() + ",'" + paramUserInfoModel.getFirstName() + "','" + paramUserInfoModel.getLastName() + "','" + paramUserInfoModel.getStreet() + "','" + paramUserInfoModel.getApt() + "','" + paramUserInfoModel.getCity() + "','" + paramUserInfoModel.getZipCode() + "','" + paramUserInfoModel.getCountryId() + "','" + paramUserInfoModel.getState() + "','" + paramUserInfoModel.getTimezoneId() + "','" + paramUserInfoModel.getEmail() + "','" + paramUserInfoModel.getPassword() + "', SYSDATE, 'New',''," + paramUserInfoModel.getMeId() + ")";
 ...
 * Qualified Name:     com.maestro.rateserver.maxim.UserInfoDAO
